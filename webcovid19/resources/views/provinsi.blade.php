...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-lg fixed-top" style="background-color: #ffffff">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item ml-5">
            ...
            <form class="form-inline" action="{{ url('/provinsi/cari') }}" method="get">
    ...
    <div class="p-4">
      <div class="content">
        <div class="row">
          <div class="p-4 rounded-lg col-md-6 shadow-lg ml-3" style="background: white;">
            ...
            <script>
        		...
        		var myChart = new Chart(ctx, {
        			...
        			data: {
        				...
        				datasets: [{
        					label: 'STATISTIK PENYEBARAN COVID-19 PROV. JABAR',
          ...
          <div class="p-4 rounded-lg shadow-lg ml-2" style="background: white; width: 495px;">
    ...
    <div class="p-3 rounded-lg shadow-lg mt-3" style="background: white;">
      <table>
        <tr>
          <td rowspan="8">
        ...
        <tr>
          <td> <p class="ml-2">Pantau terus perkembangan Pasien terjangkit, PDP / ODP</p>
            ...
            <div class="rounded bg-success mt-3">
              <p class="text-center"><a href="{{ url('/kontak') }}" class="btn btn-success btn-block"><b>LIHAT KONTAK</b></a></p>
            </div>
          </div>
          </td>
        </tr>
